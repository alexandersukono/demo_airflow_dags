...
def glo_r39_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r39,tablename)
    print(fexec.get_result())    
    
def glo_r39(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cstate, tstate FROM "+ tablename)
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r39,'glo_r39')
    print(fexec.get_result())