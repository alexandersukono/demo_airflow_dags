...
def glo_ra4_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_ra4,tablename)
    print(fexec.get_result())    
    
def glo_ra4(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cempsta2, tempsta2 FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cempsta2, tempsta2) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_ra4,'glo_ra4')
    print(fexec.get_result())