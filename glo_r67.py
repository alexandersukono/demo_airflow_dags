...
def glo_r67_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r67,tablename)
    print(fexec.get_result())    
    
def glo_r67(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, corgwwiw, ccompbu, ccomppc, clanguag, fdiscont, qsortseq, torgwwiw FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, corgwwiw, ccompbu, ccomppc, clanguag, fdiscont, qsortseq, torgwwiw ) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r67,'glo_r67')
    print(fexec.get_result())