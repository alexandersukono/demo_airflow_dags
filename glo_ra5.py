...
def glo_ra5_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_ra5,tablename)
    print(fexec.get_result())    
    
def glo_ra5(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cempsta3, tempsta3 FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cempsta3, tempsta3) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_ra5,'glo_ra5')
    print(fexec.get_result())