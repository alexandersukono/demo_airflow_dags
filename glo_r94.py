...
def glo_r94_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r94,tablename)
    print(fexec.get_result())    
    
def glo_r94(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, rdept, fdeptc, fdeptw, fdepta, rmanager, corgwwiw, cfinwwiw, cgeowwiw, clocwwiw, clcc, rdeptto, rdivision, tdept FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, rdept, fdeptc, fdeptw, fdepta, rmanager, corgwwiw, cfinwwiw, cgeowwiw, clocwwiw, clcc, rdeptto, rdivision, tdept) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r94,'glo_r94')
    print(fexec.get_result())