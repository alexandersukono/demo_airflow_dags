...
def jobsalary2_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobsalary2,tablename)
    print(fexec.get_result())    
    
def jobsalary2(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, jobid, stat, noreg, salary_band, avrist_type, avrist_plan, avrist_payment, bumida, tglcreate, tglupdate FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(id, jobid, stat, noreg, salary_band, avrist_type, avrist_plan, avrist_payment, bumida, tglcreate, tglupdate) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobsalary2,'jobsalary2')
    print(fexec.get_result())