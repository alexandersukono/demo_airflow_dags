...
def jobhist_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobhist,tablename)
    print(fexec.get_result())    
    
def jobhist(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, noreg, namaperusahaan, jenisusaha, departemen, jabatan, lama_kerja_from, lama_kerja_to, gaji, jobdesc, [wr-nama], [wr-departemen], [wr-jabatan], [wr-telepon], [wr-keterangan] FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(id, noreg, namaperusahaan, jenisusaha, departemen, jabatan, lama_kerja_from, lama_kerja_to, gaji, jobdesc, `wr-nama`, wr-departemen, wr-jabatan, wr-telepon, wr-keterangan) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobhist,'jobhist')
    print(fexec.get_result())