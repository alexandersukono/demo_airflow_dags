...
def glo_kepegawaian_function(tablename):
...
conn1 = pyodbc.connect(
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, kepegawaian, usedate, salary FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(id, kepegawaian, usedate, salary) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_kepegawaian,'glo_kepegawaian')
    print(fexec.get_result())