...
def glo_r03_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r03,tablename)
    print(fexec.get_result())    
    
def glo_r03(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, caddrtyp, taddrtyp FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, caddrtyp, taddrtyp) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r03,'glo_r03')
    print(fexec.get_result())