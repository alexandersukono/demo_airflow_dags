...
def hriw_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(hriw,tablename)
...
def hriw(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, stat, lastupd, noreg, ibmjtiecode, empfirstname, emplastname, empprefname, empinitial, sexcode, employeetype, bu," +
                 "sourceid, countrycode, cocode, orgcd, financialqualifier, resignationtype, recruitmenttype, hiretype, dateofhire, lastworkingday," +
                 "dateofbirth, currencycd, annualbasesalary, incentive, prgcode, employeestatus, salaryband, dateinsalaryband, manajernon, acctdeptcode," +
                 "acctmajorcode, acctdivisioncode, primaryjobcode, secondaryjobcode, deptname, entitycode, projectid, pos, pbc FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(id, stat, lastupd, noreg, ibmjtiecode, empfirstname, emplastname, empprefname, empinitial, sexcode, employeetype, bu," +
                 "sourceid, countrycode, cocode, orgcd, financialqualifier, resignationtype, recruitmenttype, hiretype, dateofhire, lastworkingday," +
                 "dateofbirth, currencycd, annualbasesalary, incentive, prgcode, employeestatus, salaryband, dateinsalaryband, manajernon, acctdeptcode," +
                 "acctmajorcode, acctdivisioncode, primaryjobcode, secondaryjobcode, deptname, entitycode, projectid, pos, pbc) \
        VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",records)
    conn2.commit()
