...
def jobsalaryfreelance_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobsalaryfreelance,tablename)
    print(fexec.get_result())    
    
def jobsalaryfreelance(tablename):
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobsalaryfreelance,'jobsalaryfreelance')
    print(fexec.get_result())