...
def glo_ra3_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_ra3,tablename)
    print(fexec.get_result())    
    
def glo_ra3(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cempsta1, tempsta1 FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cempsta1, tempsta1) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_ra3,'glo_ra3')
    print(fexec.get_result())