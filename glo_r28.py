...
def glo_r28_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r28,tablename)
    print(fexec.get_result())    
    
def glo_r28(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, csalbiw, tsalbiw FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, csalbiw, tsalbiw) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r28,'glo_r28')
    print(fexec.get_result())