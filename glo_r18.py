...
def glo_r18_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r18,tablename)
    print(fexec.get_result())    
    
def glo_r18(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cjobc1iw, cjobc2iw, tcjobiw FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cjobc1iw, cjobc2iw, tcjobiw) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r18,'glo_r18')
    print(fexec.get_result())