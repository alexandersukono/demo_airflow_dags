...
def glo_r25_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r25,tablename)
    print(fexec.get_result())    
    
def glo_r25(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cpbcrat, tspbcrat, tpbcrat FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cpbcrat, tspbcrat, tpbcrat) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r25,'glo_r25')
    print(fexec.get_result())