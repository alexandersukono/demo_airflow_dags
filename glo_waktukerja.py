...
def glo_waktukerja_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_waktukerja,tablename)
    print(fexec.get_result())    
    
def glo_waktukerja(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, namashift, timeinout, istirahat1, istirahat2, istirahat3, istirahat4, istirahat5, jkerja, jlembur, lob, defolt, tolin, tolout, sw FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(id, namashift, timeinout, istirahat1, istirahat2, istirahat3, istirahat4, istirahat5, jkerja, jlembur, lob, defolt, tolin, tolout, sw) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_waktukerja,'glo_waktukerja')
    print(fexec.get_result())