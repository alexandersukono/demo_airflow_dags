...
def glo_r93_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r93,tablename)
    print(fexec.get_result())    
    
def glo_r93(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, rdivision, tdivision FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, rdivision, tdivision) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r93,'glo_r93')
    print(fexec.get_result())