...
def glo_r19_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r19,tablename)
    print(fexec.get_result())    
    
def glo_r19(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cjobfam, tjobfam FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cjobfam, tjobfam) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r19,'glo_r19')
    print(fexec.get_result())