...
def glo_r21_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r21,tablename)
    print(fexec.get_result())    
    
def glo_r21(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, cmgriw, cmgrws, tmgriw FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, cmgriw, cmgrws, tmgriw) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r21,'glo_r21')
    print(fexec.get_result())