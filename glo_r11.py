...
def glo_r11_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r11,tablename)
    print(fexec.get_result())    
    
def glo_r11(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT cmodel, ceducliw, teducliw FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(cmodel, ceducliw, teducliw) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_r11,'glo_r11')
    print(fexec.get_result())