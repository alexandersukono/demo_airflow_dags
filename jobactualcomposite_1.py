...
def jobactualcomposite_1_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobactualcomposite_1,tablename)
    print(fexec.get_result())    
    
def jobactualcomposite_1(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, stat, noreg, tglcreate, tglupdate, tglkerja, tglend, first, second, third, composite FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipdbms." +tablename+ "(id, stat, noreg, tglcreate, tglupdate, tglkerja, tglend, first, second, third, composite) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(jobactualcomposite_1,'jobactualcomposite_1')
    print(fexec.get_result())